...
Consider three different sequences of nested sets $\Sigma_1^k\supset\dots\supset\Sigma_{10}^k$ for $k=1,2,3$.
...
If there are no more smaller sets available from the originally constructed sequence, we generate $l$ new ones and choose the best one between them.
